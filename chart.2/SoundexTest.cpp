...
TEST_F(SoundexEncoding, CombinesDuplicateEncodings){
    ASSERT_THAT(soundex.encodedDigits('b'), soundex.encodedDigits('f'));
    ASSERT_THAT(soundex.encodedDigits('c'), soundex.encodedDigits('g'));
    ASSERT_THAT(soundex.encodedDigits('d'), soundex.encodedDigits('t'));
